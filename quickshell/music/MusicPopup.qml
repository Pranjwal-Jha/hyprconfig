...
Item {
    ...
    Item {
        ...
        Rectangle {
            ...
            Item {
                ...
                Rectangle {
                    anchors.fill: parent
                    color: Qt.rgba(root.base.r, root.base.g, root.base.b, 0.4)
                    radius: root.s(20)
                }
            ...
            ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        ColumnLayout {
                            ...
                            RowLayout {
                                ...
                                Rectangle {
                                    ...
                                    radius: root.s(12)
                                    Layout.preferredHeight: root.s(28)
                                    Layout.preferredWidth: pillContent.width + root.s(24)
                                    ...
                                    RowLayout {
                                        ...
                                        Text { text: root.musicData.deviceName || "Speaker"; color: root.subtext1; font.family: "JetBrains Mono"; font.pixelSize: root.s(12); font.bold: true }
                                    }
                                }
                                Text {
                        ...
                        ColumnLayout {
                            ...
                            Slider {
                                ...
                                background: Item {
                                    ...
                                    y: progBar.topPadding + (progBar.availableHeight - root.s(8)) / 2
                                    ...
                                    Item {
                                        ...
                                        Rectangle {
                                            ...
                                            gradient: Gradient {
                                                ...
                                                GradientStop { position: 0.0000; color: root.blue; Behavior on color { ColorAnimation { duration: 800 } } }
                                                GradientStop { position: 0.3333; color: root.mauve; Behavior on color { ColorAnimation { duration: 800 } } }
                                                GradientStop { position: 0.6666; color: root.pink; Behavior on color { ColorAnimation { duration: 800 } } }
                                                GradientStop { position: 1.0000; color: root.blue; Behavior on color { ColorAnimation { duration: 800 } } }
                                            }
                                        }
                                    }
                                }
                                ...
                                handle: Rectangle {
                                    ...
                                    implicitWidth: root.s(14) 
                                    implicitHeight: root.s(14)
                                    width: root.s(14); height: root.s(14)
                                    radius: root.s(7); color: root.text
                                    scale: progBar.pressed ? 1.4 : 1.0
                                    Behavior on scale { NumberAnimation { duration: 150; easing.type: Easing.OutBack } }
                                    layer.enabled: true
                                    layer.effect: MultiEffect {
                                        shadowEnabled: true; shadowColor: "#000000"; shadowOpacity: 0.4; shadowBlur: 0.2
                                    }
                                }
                            }
                            ...
                            RowLayout {
                                Layout.fillWidth: true
                                Text { text: root.musicData.positionStr || "00:00"; color: root.subtext0; font.family: "JetBrains Mono"; font.bold: true; font.pixelSize: root.s(12) }
                                Item { Layout.fillWidth: true }
                                Text { text: root.musicData.lengthStr || "00:00"; color: root.subtext0; font.family: "JetBrains Mono"; font.bold: true; font.pixelSize: root.s(12) }
                            }
                        }
                        ...
                        RowLayout {
                            ...
                            MouseArea {
                                ...
                                Text { anchors.centerIn: parent; text: "󰙣"; color: parent.pressed ? root.text : root.subtext1; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(32) }
                            }
                            Rectangle {
                                id: playPauseBtn
                                ...
                                border.color: Qt.rgba(root.mauve.r, root.mauve.g, root.mauve.b, 0.3)
                                border.width: 1
                                
                                layer.enabled: true
                                layer.effect: MultiEffect {
                                    shadowEnabled: true; shadowColor: root.mauve; shadowOpacity: 0.2; shadowBlur: 0.8
                                }
                                ...
                                MouseArea {
                                    ...
                                    Text { 
                                        ...
                                        color: root.mauve; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(32) 
                                        x: root.musicData.status === "Playing" ? 0 : root.s(3)
                                    }
                                }
                            ...
                            MouseArea {
                                ...
                                Text { anchors.centerIn: parent; text: "󰙦"; color: parent.pressed ? root.text : root.subtext1; font.family: "Iosevka Nerd Font"; font.pixelSize: root.s(32) }
                            }
                        }
                    }
                }
                ...
                Rectangle {
                    ...
                    Layout.topMargin: root.s(35)
                    Layout.bottomMargin: root.s(15)
                    color: "#1AFFFFFF"
                    radius: 0
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            Layout.preferredWidth: applyTxt.width + root.s(32)
                            radius: root.s(16)
                            color: root.eqData.pending ? Qt.rgba(root.mauve.r, root.mauve.g, root.mauve.b, 0.2) : root.surface1
                            border.color: root.eqData.pending ? root.mauve : Qt.rgba(1,1,1,0.05)
                            border.width: 1
                            ...
                            layer.effect: MultiEffect {
                                shadowEnabled: true; shadowColor: root.mauve; shadowOpacity: 0.2; shadowBlur: 0.4
                            }

                            Text {
                                id: applyTxt
                                anchors.centerIn: parent
                                text: root.eqData.pending ? "APPLY CHANGES" : "SAVED"
                                color: root.eqData.pending ? root.mauve : root.subtext0
                                font.family: "JetBrains Mono"
                                    ...
                                    ColumnLayout {
                                        ...
                                        Slider {
                                            ...
                                            background: Rectangle {
                                                ...
                                                implicitWidth: root.s(8) 
                                                implicitHeight: root.s(150)
                                                width: root.s(8); height: eqSlider.availableHeight
                                                radius: root.s(4); 
                                            ...
                                            handle: Rectangle {
                                                ...
                                                property var catColors: [root.mauve, root.pink, root.blue, root.mauve, root.sapphire]
    ...
    component PresetButton : Rectangle {
        ...
        color: isActivePreset ? root.mauve : (isHovered ? root.surface1 : Qt.rgba(root.surface0.r, root.surface0.g, root.surface0.b, 0.8))
