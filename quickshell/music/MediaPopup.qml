...
Item {
                ...
                Item {
                    ...
                    component TextSlot: Column {
                        ...
                        Rectangle {
                            ...
                            radius: height / 2
                            color: Qt.rgba(root.clock.r, root.clock.g, root.clock.b, 0.15)
                            Row {
                                id: slotPillRow
                                anchors.centerIn: parent
                                spacing: 4
    ...
    component PlayerNavButton: Rectangle {
        ...
        property color accentColor: root.clock
        signal clicked()
        width: 36; height: 36; radius: 10
        color: navMouse.containsMouse ? Qt.lighter(root.rowBackground, 1.3) : root.rowBackground
        ...
        Text {
            ...
            font.pixelSize: 16
            font.family: "JetBrainsMono Nerd Font"
            color: navMouse.containsMouse ? navBtn.accentColor : root.textMain
            Behavior on color { ColorAnimation { duration: 120 } }
        }
        MouseArea {
            id: navMouse
    ...
    component WaveBar: Item {
        ...
        Rectangle {
            ...
            anchors.verticalCenter: parent.verticalCenter
            color: bar.hovered ? Qt.rgba(root.trackBackground.r, root.trackBackground.g, root.trackBackground.b, 0.4) : Qt.lighter(root.trackBackground, 1.1)
    ...
    component MediaButton: Rectangle {
        ...
        color: {
            if (!enabled) return Qt.rgba(root.rowBackground.r, root.rowBackground.g, root.rowBackground.b, 0.35)
            if (highlighted) return btnMouse.containsMouse ? Qt.lighter(accentColor, 1.1) : accentColor
            return btnMouse.containsMouse ? Qt.lighter(root.rowBackground, 1.25) : root.rowBackground
        }
        ...
        Text {
            ...
            color: {
                if (!btn.enabled)    return root.textDim
                if (btn.highlighted) return root.pillForeground
                return btnMouse.containsMouse ? root.textAccent : root.textMain
            }
            Behavior on color { ColorAnimation { duration: 120 } }
        }
        MouseArea {
